...
def main():
    ...
    parser.add_argument("--save_dir", type=str, default="/data/gaowh/data/ckpt_gat_att/",
                        help="model save dir.")
    ...
    if not os.path.exists('/data/gaowh/data/ckpt_gat_att'):
        os.mkdir('/data/gaowh/data/ckpt_gat_att')
    ...
    if args.model_type == 'gat':
        print('载入gat模型...')
        model = BertGAT_org(args, embed_matrix)
