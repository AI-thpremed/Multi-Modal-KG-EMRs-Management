...
def main():
    ...
    parser.add_argument("--save_dir", type=str, default="/data/gaowh/data/ckpt_gat_pure/",
                        help="model save dir.")
    ...
    if not os.path.exists('/data/gaowh/data/ckpt_gat_pure'):
        os.mkdir('/data/gaowh/data/ckpt_gat_pure')
