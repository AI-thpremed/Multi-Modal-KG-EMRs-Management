...
def get_graphs():
    ...
    读取图数据
    """
    fp = open('/data/gaowh/data/clean_kg.json', 'w', encoding='utf-8')
...
def build_graph_dataset():
    ...
    g_train_fp = open('/data/gaowh/data/g_sim_train.json', 'w', encoding='utf-8')
    g_valid_fp = open('/data/gaowh/data/g_sim_valid.json', 'w', encoding='utf-8')
